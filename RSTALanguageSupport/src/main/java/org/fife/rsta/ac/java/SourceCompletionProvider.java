...
class SourceCompletionProvider extends DefaultCompletionProvider {
	...
	/**
	 * Whether to hide compiler-generated synthetic fields (e.g.
	 * {@code class$0}, {@code class$1}) from completion results.
	 * These fields are generated by compilers for {@code .class} literal
	 * expressions when targeting pre-Java 5 bytecode.  Defaults to
	 * {@code true}.
	 */
...
public SourceLocation getSourceLocForClass(String className) {
	...
	private boolean isAccessible(MemberInfo info, String pkg) {
		...
		// Filter compiler-generated synthetic fields (e.g. class$0, class$1)
		// produced for .class literal expressions in pre-Java 5 bytecode.
		if (hideSyntheticFields && info instanceof FieldInfo) {
