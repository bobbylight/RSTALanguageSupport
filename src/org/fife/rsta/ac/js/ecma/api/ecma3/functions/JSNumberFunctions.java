...
public interface JSNumberFunctions extends JSObjectFunctions {
	 ...
	 * <code>
	 * 	var n = 12345.6789;<br>
	 *  n.toFixed(); //returns 12346: note rounding up<br>
	 *  n.toFixed(1); //returns 12345.7: note rounding up<br>
	 *  n.toFixed(6); //returns 12345.678900: note zeros<br>
	 *  (1.23e+20).toFixed(2); //returns 123000000000000000000.00<br>
	 * </code> 
     * @memberOf Number
	 ...
	 * <code>
	 * 	var n = 12345.6789;<br>
	 *  n.toExponential(1); //returns 1.2e+4<br>
	 *  n.toExponential(5); //returns 1.23457e+4<br>
	 *  n.toExponential(10); //returns 1.2345678900e+4<br>
	 *  n.toExponential(); //returns 1.23456789e+4<br>
	 * </code> 
     * @memberOf Number
	 ...
	 * <code>
	 * 	var n = 12345.6789;<br>
	 *  n.toPrecision(1); //returns 1e+4<br>
	 *  n.toPrecision(3); //returns 1.23e+4<br>
	 *  n.toPrecision(5); //returns 12346<br>
	 *  n.toPrecision(10); //returns 12345.67890<br>
	 * </code>
     * @memberOf Number
