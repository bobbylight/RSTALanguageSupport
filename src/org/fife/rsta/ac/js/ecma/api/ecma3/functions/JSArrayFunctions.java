...
public interface JSArrayFunctions extends JSObjectFunctions {
	 ...
	 * </code> 
	 * 
	 * @param {Array} args ...Any number of values to be concatenated to an <b>array</b>
	 * @returns {Array} A new <b>array</b>
	 * @memberOf Array
	 ...
	 * </code> 
	 * 
	 * @param {String} <i>separator</i> An optional character or string used to separate each element with the string.  
	 * @returns {String} A string representing the result of all the elements in the <b>array</b> concatenated together, separated by the separator. 
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @since Standard ECMA-262 3rd. Edition
	 * @since Level 2 Document Object Model Core Definition.
	 ...
	 * </code> 
	 * @returns {Object} The last element of the <b>array</b>
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 ...
	 * </code> 
	 * @param {Array} args One or more values to be appended to the end of the <b>array</b>
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @see #pop()
	 * @since Standard ECMA-262 3rd. Edition
	 ...
	 * </code> 
	 * @returns {Array} The <b>array</b> after it has been reversed
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @since Standard ECMA-262 3rd. Edition
	 * @since Level 2 Document Object Model Core Definition.
	 ...
	 * </code> 
	 * @returns {Object} The former first element of the <b>array</b>
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @see #pop() pop()
	 ...
	 * </code> 
	 * @param {Number} start The array index from where to begin.  If negative, this argument specifies a position measured from the end of the array. 
	 * @param {Number} end The array index immediately after the end of the slice. If not specified then the slice includes all the array elements from the start to the end of the array.
	 * @returns {Array} A new <b>array</b> containing elements from the <b><i>start</b></i> up to, but not including the <b><i>end</i></b> of the slice.
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 ...
	 * </code> 
	 * @param {Function} <i>function</i> an optional function used to specify the sorting order
	 * @returns {Array} A reference to the <b>array</b>
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @since Standard ECMA-262 3rd. Edition
	 * @since Level 2 Document Object Model Core Definition.
	 ...
	 * </code> 
	 * @param {Number} start the <b>array</b> element at which the insertion and/or deletion is to begin
	 * @param {Number} <i>deletecount</i> The number of elements starting with and including <i><b>start</b></i>. 
	 * @param {Array} items zero or more items to be inserted into the <b>array</b>
	 * @returns {Array} An <b>array</b> containing the elements, if any, deleted from the <b>array</b>
	 * @memberOf Array
	 * @see org.fife.rsta.ac.js.ecma.api.ecma3.JSArray Array
	 * @see #shift() shift();
	 * @since Standard ECMA-262 3rd. Edition
	 ...
	 * </code> 
	 * @param {Array} value One or more values to insert at the beginning of the <b>array</b>
