...
import org.fife.rsta.ac.bsh.buildpath.LibraryInfo;
import org.fife.rsta.ac.bsh.buildpath.SourceLocation;
import org.fife.rsta.ac.bsh.classreader.ClassFile;
import org.fife.rsta.ac.bsh.classreader.FieldInfo;
import org.fife.rsta.ac.bsh.classreader.MemberInfo;
import org.fife.rsta.ac.bsh.classreader.MethodInfo;
...
import org.fife.rsta.ac.bsh.rjc.ast.Member;
...
import org.fife.rsta.ac.bsh.rjc.lang.TypeParameter;
...
public SourceLocation  getSourceLocForClass(String className) {
	...
	private boolean isAccessible(MemberInfo info, String pkg) {
		...
		if (org.fife.rsta.ac.bsh.classreader.Util.isPublic(access) ||
				org.fife.rsta.ac.bsh.classreader.Util.isProtected(access)) {
			accessible = true;
		}
		else if (org.fife.rsta.ac.bsh.classreader.Util.isDefault(access)) {
