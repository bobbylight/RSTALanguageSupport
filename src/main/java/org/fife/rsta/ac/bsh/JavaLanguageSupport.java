...
import org.fife.rsta.ac.bsh.tree.JavaOutlineTree;
...
public class JavaLanguageSupport extends AbstractLanguageSupport {
    ...
    private static final String PROPERTY_LISTENER
            = "org.fife.rsta.ac.bsh.JavaLanguageSupport.Listener";
    ...
    /**
     * Returns the shared jar manager instance. NOTE: This method will be
     * removed over time, as the Java support becomes more robust!
     *
     ...
     * added. This is used internally when a class completion is inserted, and
     * it needs an import statement added to the source.
     */
...
//				updateTable();
    ...
    private class JavaAutoCompletion extends AutoCompletion {
         ...
         * inserted.<p>
         *
         * Thanks to Guilherme Joao Frantz and Jonatas Schuler for helping with
         * the patch!
         *
